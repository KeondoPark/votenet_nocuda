...
class Pointnet2Backbone(nn.Module):
    ...
    def forward(self, pointcloud: torch.cuda.FloatTensor, end_points=None):
        ...
        xyz, features, fps_inds, ball_query_idx = self.sa1(xyz, features)
        end_points['sa1_inds'] = fps_inds
        end_points['sa1_xyz'] = xyz
        end_points['sa1_features'] = features
        end_points['sa1_ball_query_idx'] = ball_query_idx

        xyz, features, fps_inds, ball_query_idx = self.sa2(xyz, features) # this fps_inds is just 0,1,...,1023
        end_points['sa2_inds'] = fps_inds
        end_points['sa2_xyz'] = xyz
        end_points['sa2_features'] = features
        end_points['sa2_ball_query_idx'] = ball_query_idx

        xyz, features, fps_inds, ball_query_idx = self.sa3(xyz, features) # this fps_inds is just 0,1,...,511
        end_points['sa3_inds'] = fps_inds
        end_points['sa3_xyz'] = xyz
        end_points['sa3_features'] = features
        end_points['sa3_ball_query_idx'] = ball_query_idx

        xyz, features, fps_inds, ball_query_idx = self.sa4(xyz, features) # this fps_inds is just 0,1,...,255
